...
/**
 * CreateFotaScheduleRequest
 */
@lombok.Data @lombok.Builder @lombok.NoArgsConstructor @lombok.AllArgsConstructor

@JsonTypeName("createFotaSchedule_request")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-01-19T16:30:08.398412+09:00[Asia/Seoul]", comments = "Generator version: 7.18.0")
public class CreateFotaScheduleRequest {
  ...
  @Schema(name = "fwType", example = "M", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("fwType")
  ...
  @Schema(name = "pollingTarget", example = "SERVICE", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
