...
public class Device {
  ...
  @Schema(name = "deviceCd", description = "디바이스 모델 코드", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  @Schema(name = "deviceNm", description = "디바이스 모델명", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  @Schema(name = "anTypeList", example = "[10,10000000]", description = "서비스망 목록", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("anTypeList")
  @Valid
  private List<String> anTypeList = new ArrayList<>();

  @NotNull @Size(min = 0, max = 10) 
  @Schema(name = "deviceType", description = "디바이스 유형", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("deviceType")
  private String deviceType;

  @NotNull @Size(min = 0, max = 20) 
  @Schema(name = "deviceManu", example = "manager", description = "담당자 아이디", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("deviceManu")
  private String deviceManu;

  @NotNull @Pattern(regexp = "^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$") @Size(min = 0, max = 50) 
  @Schema(name = "deviceEmail", example = "manager@abacus.com", description = "담당자 이메일", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  @Schema(name = "modemNm", description = "모듈 모델명", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
