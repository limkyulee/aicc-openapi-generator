...
public class Menu {
  ...
  @Schema(name = "menuId", description = "메뉴 아이디", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("menuId")
  private String menuId;

  @NotNull @Size(min = 0, max = 50) 
  @Schema(name = "menuNm", description = "메뉴 명", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("menuNm")
  private String menuNm;

  @NotNull @Size(min = 0, max = 150) 
  @Schema(name = "menuUrl", description = "메뉴 URL", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("menuUrl")
  private String menuUrl;

  @NotNull @Size(min = 0, max = 20) 
  @Schema(name = "mdlCd", description = "모듈 ID", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("mdlCd")
  private String mdlCd;

  @NotNull 
  @Schema(name = "headerMenuYn", description = "헤더 메뉴 여부", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("headerMenuYn")
  private String headerMenuYn;

  @NotNull 
  @Schema(name = "menuOrd", description = "메뉴 순서", requiredMode = Schema.RequiredMode.REQUIRED)
